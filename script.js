...
const translations = {
  en: {
    ...
    "proj.rtype.role": "Built the SFML client renderer and contributed to server-side game systems and the network protocol.",
    ...
    "proj.area.role": "Built frontend views (services catalog, dashboard) and authored the architecture documentation.",
    ...
    "proj.zappy.role": "Built server networking (sockets, client lifecycle) and core game logic — resource distribution, player/egg management, time management.",
    ...
    "proj.arcade.role": "Implemented the Nibbler game module and the graphics abstraction interfaces (IGame/IGraphics) shared across libraries.",
    ...
    "projectsPage.intro": "A closer look at the group and solo projects I built at EPITECH — the goals, the tech, and the specific parts I owned.",
  ...
  fr: {
    ...
    "proj.rtype.role": "Développement du rendu client SFML et contribution aux systèmes de jeu côté serveur ainsi qu'au protocole réseau.",
    "proj.rtype.stack": "Stack : C++20, SFML, ECS, UDP, CMake",
    "proj.area.title": "AREA",
    ...
    "proj.area.role": "Développement des vues frontend (catalogue de services, tableau de bord) et rédaction de la documentation d'architecture.",
    "proj.area.stack": "Stack : FastAPI, Vue 3, PostgreSQL, Docker, Android",
    "proj.zappy.title": "Zappy",
    ...
    "proj.zappy.role": "Développement du réseau serveur (sockets, cycle de vie des clients) et de la logique de jeu principale — distribution des ressources, gestion des joueurs/œufs, gestion du temps.",
    "proj.zappy.stack": "Stack : C, C++, Doxygen",
    "proj.arcade.title": "Arcade",
    ...
    "proj.arcade.role": "Implémentation du module de jeu Nibbler et des interfaces d'abstraction graphique (IGame/IGraphics) partagées entre les bibliothèques.",
    "proj.arcade.stack": "Stack : C++, dlopen, SDL2, SFML, ncurses",
    "proj.raytracer.title": "Raytracer",
    ...
    "projectsPage.intro": "Un aperçu des projets de groupe et solo réalisés à EPITECH — les objectifs, les technologies, et la partie précise dont je me suis occupé.",
