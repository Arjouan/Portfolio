...
const translations = {
  en: {
    ...
    "projectsPage.intro": "A closer look at the group and solo projects I built at EPITECH — the goals, the tech, and the specific parts I owned. Across team projects, I paired hands-on feature work with ownership of the technical documentation — architecture diagrams, API references, contribution guides — that kept fast-moving codebases consistent for the rest of the team.",
  ...
  fr: {
    ...
    "projectsPage.intro": "Un aperçu des projets de groupe et solo réalisés à EPITECH — les objectifs, les technologies, et la partie précise dont je me suis occupé. Sur les projets de groupe, j'ai combiné des contributions concrètes aux fonctionnalités avec la responsabilité de la documentation technique — diagrammes d'architecture, références API, guides de contribution — qui a gardé des bases de code en évolution rapide cohérentes pour le reste de l'équipe.",
