...
const translations = {
  en: {
    ...
    "hero.subtitle": "Singapore-born, bilingual in English and French, now in my 4th year at EPITECH on a one-year exchange at McGill University. I am building a career at the intersection of management, commerce, and information technology.",
    ...
    "proj.rtype.role": "Kept the documentation current — README, architecture doc, API reference — and contributed small client-side gameplay features (enemy variety, projectile and collision behavior, visual polish).",
    ...
    "proj.area.role": "Focused on project organization and onboarding — wrote the CONTRIBUTING guide and the architecture diagrams the team worked from, kept the README current, and built a couple of frontend views (services catalog, dashboard).",
    ...
    "proj.zappy.role": "Documented the codebase end-to-end with Doxygen across the server, AI client, and GUI, and started the README — support work that kept every team member's modules readable and consistent.",
    ...
    "proj.arcade.role": "Wrote and maintained the project's documentation (inline function docs, README, the published doc site) and implemented the Nibbler game module.",
    "proj.arcade.stack": "Stack: C++, dlopen, SDL2, SFML, ncurses",
    "projectsPage.about": "About the project",
    "projectsPage.mediaSoon": "Screenshots and a demo video are coming soon.",
    ...
    "projectsPage.intro": "A closer look at the group and solo projects I built at EPITECH — the goals, the tech, and the specific parts I owned. On team projects I often ended up in a support and organization role: documentation, architecture write-ups, and keeping the project structure consistent for everyone else, alongside hands-on feature work.",
  ...
  fr: {
    ...
    "hero.subtitle": "Né à Singapour, bilingue anglais et français, maintenant en 4e année à EPITECH en échange d'un an à McGill University. Je construis ma carrière à l'intersection du management, du commerce et des technologies de l'information.",
    ...
    "proj.rtype.role": "Maintien de la documentation à jour — README, document d'architecture, référence API — et contribution à quelques fonctionnalités de gameplay côté client (variété des ennemis, comportement des projectiles et des collisions, finitions visuelles).",
    "proj.rtype.stack": "Stack : C++20, SFML, ECS, UDP, CMake",
    "proj.area.title": "AREA",
    ...
    "proj.area.role": "Concentré sur l'organisation du projet et l'onboarding — rédaction du guide de contribution et des diagrammes d'architecture utilisés par l'équipe, maintien du README à jour, et développement de quelques vues frontend (catalogue de services, tableau de bord).",
    "proj.area.stack": "Stack : FastAPI, Vue 3, PostgreSQL, Docker, Android",
    "proj.zappy.title": "Zappy",
    ...
    "proj.zappy.role": "Documentation du code de bout en bout avec Doxygen sur le serveur, le client IA et l'interface graphique, et démarrage du README — un travail de support qui a gardé les modules de toute l'équipe lisibles et cohérents.",
    "proj.zappy.stack": "Stack : C, C++, Doxygen",
    "proj.arcade.title": "Arcade",
    ...
    "proj.arcade.role": "Rédaction et maintien de la documentation du projet (documentation des fonctions, README, site de documentation publié) et implémentation du module de jeu Nibbler.",
    "proj.arcade.stack": "Stack : C++, dlopen, SDL2, SFML, ncurses",
    "proj.raytracer.title": "Raytracer",
    ...
    "projectsPage.mediaSoon": "Captures d'écran et vidéo de démonstration à venir.",
    ...
    "projectsPage.intro": "Un aperçu des projets de groupe et solo réalisés à EPITECH — les objectifs, les technologies, et la partie précise dont je me suis occupé. Sur les projets de groupe, j'ai souvent tenu un rôle de support et d'organisation : documentation, notes d'architecture, et cohérence de la structure du projet pour le reste de l'équipe, en plus de contributions concrètes aux fonctionnalités.",
